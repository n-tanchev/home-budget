export const en = {
  ...
  projects: {
    ...
    active: 'Active',
    archived: 'Archived',
    noProjects: 'No projects yet. Create one to track expenses for a specific goal.',
    noArchived: 'No archived projects.',
    namePlaceholder: 'e.g. Kitchen renovation',
    ...
    expenses: 'Expenses',
    addExpense: 'Add expense',
    noExpenses: 'No expenses for this project yet.',
    project: 'Project',
    none: '(None)',
    monthlyBreakdown: 'Monthly breakdown',
    backToProjects: 'Back to projects',
    confirmDeleteTitle: 'Delete project?',
    confirmDeleteMessage: 'Delete "{name}"? Expenses linked to this project will remain in the monthly tables but become unassigned.',
    progress: 'Progress',
  },
